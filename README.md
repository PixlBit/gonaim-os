...
مساحة الاثنين صار لها مستودعها: **[`PixlBit/ehna-os`](https://github.com/PixlBit/ehna-os)**.

نُقلت بتاريخها كاملًا لا بنسخة: ما يُبنى ليعيش عشرين سنة لا يُربط بمستودع
يتغيّر شكله. وكان ربطها بما هنا سطرًا واحدًا، فالفصل كلّف ما يكلّفه سطر.
