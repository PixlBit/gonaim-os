...
## ⚠️ تفريعة لازم تختار فيها — لحظة ضياع القلم

عندنا دلوقتي نسختين للحظة الواحدة:

| | `beats/B07-CHASM-AND-PAPER-COLUMNS.md` | `pack/P06-DRAGON-SHADOW-PENCIL-LOSS.md` |
|---|---|---|
| اللي بيطاردها | عمودين ورق عملاقين وفتحة ضيقة بالطول | ظل تنين |
| نهاية الكليب | القلم بيطير وهي بتقع في مكان مفتوح | القلم بيتمسك وبيبقى مظلة |
| المظلة | **مافيش** (مشيلة صراحة) | موجودة في الشوتين الأخيرين |

دول **بدايل مش متتاليين** — ماينفعش الاتنين في نفس الفيلم لأن القلم بيضيع مرتين.

أنضف تركيب لو عايز الاتنين: خُد `B07` كامل (العمودين + الحشر + الوقوع + القلم بيطير)، وبعده
شوتات 3–4 من `P06` بس (الإمساك بالقلم + المظلة). كده الظل والعمودين ما بيتخانقوش والقلم بيضيع
مرة واحدة.
