...
rubber cable and woven wire mesh each keep their own distinct painted character.
Each crumpled ball is painted as a solid object with faceted relief and its own contact
shadow, never a flat cut-out disc.

CRITICAL DISTINCTION: the room is painted with depth and the drawings are not. Every drawing on every
