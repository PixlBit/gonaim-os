...
-- إصلاح: طبقة Whisper كانت ناقصة في 0001. Expansion §10.2 تعرّف خمس طبقات
-- اقتراح: Whisper · Nudge · Window · Interrupt · Block — والملاحظة الصغيرة داخل
-- السياق هي أخف تدخل ممكن، فلا يصح إسقاطها.
